...
extension Header {
	...
	final class View: NSObject, NSMenuDelegate {
		...
		private var circuitSelectorView: Circuit.Selector.View?
...
extension Header.View: @MainActor MenuItemDisplaying {
	public func menuItems(with screen: Screen) -> [NSMenuItem] {
		circuitSelectorView = circuitSelectorView ?? screen.circuitSelectorScreen.map(Circuit.Selector.View.init)
